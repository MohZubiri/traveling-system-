                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-columns  dropdown-menu-columns-2">
                            <li>
                            <span class="dropdown-header"> {{__('nav.userSettings')}}</span>
                                <span></span>
                            ...
                            <li>
                                <a class="dropdown-item" href="{{route('admin.visas.index')}}">
                                {{__('nav.visas')}}
                                </a>
                            </li>
                            <li>
                            ...
                            <li class="dropright">
                                <a class="dropdown-item dropdown-toggle" href="#sidebar-error" data-toggle="dropdown"
