        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item d-flex justify-content-between align-items-center" href="{{ route('language.switch', ['locale' => 'ar']) }}">
                                <span>
                                    <span class="flag-icon">🇾🇪</span>
                                    <span>العربية</span>
                                </span>
                            ...
                            <a class="dropdown-item d-flex justify-content-between align-items-center" href="{{ route('language.switch', ['locale' => 'en']) }}">
                                <span>
                                @if(session()->get('locale') === 'ar')
                                <span>English</span>
                                <span class="flag-icon">🇺🇸</span>
