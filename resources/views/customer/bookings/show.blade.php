        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @if($booking->notes)
                        <div class="mb-4">
                            <label class="text-muted d-block mb-2">ملاحظات</label>
                ...
                <div class="card-footer bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('customer.bookings.index') }}" class="btn btn-light">
                            <i class="fas fa-arrow-right me-1"></i> العودة للحجوزات
                        </a>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach($booking->tickets as $ticket)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('customer.bookings.tickets.download', $ticket) }}" 
